...
import { X, Radio, Zap, Trophy, Target, Brain, Moon, Activity, Apple, Database, ChevronLeft, ChevronRight, Heart, Settings, Rocket, Flame, Loader2, Check } from 'lucide-react';
